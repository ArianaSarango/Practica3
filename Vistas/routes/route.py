...
def get_familia_generador_data():
    ...
    familias = load_data('/home/aris/Documents/Taller_Domingo_LINKED_LIST/Taller_Domingo_2json/src/main/java/Data/Familia.json')
...
@router.route('/admin/familia/buscar/<criterio>/<texto>')
def view_buscar_familia(criterio, texto):
    url = 'http://localhost:8086/api/familia/list/buscar/'
